...
class IcdeDataBase:
    ...
    def update_lastloggedin_time(self, user):
    ...
    def update_usagetime(self, user, start_time, end_time):
    ...
    def collect_courses_data(self, user, stream):
    ...
    def collect_usage_stats(self, user):
