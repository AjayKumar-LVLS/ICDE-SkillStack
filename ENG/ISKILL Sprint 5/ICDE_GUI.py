    ...
    def __init__(self):
        ...
        def EnrollmentPage():
            ...
            tk.Button(self.enroll_drop_frame, text="Enroll", width=30, bg="yellow green", font="helvetica, 12",
                      command=lambda: [self.enroll(current_user, selected_course)]).place(x=270, y=120)
            tk.Button(self.enroll_drop_frame, text="Drop", width=30, bg="indian red", font="helvetica, 12",
                      command=lambda: [self.drop(current_user, selected_course)]).place(x=270, y=160)
        ...
        def Teccoursepage():
            ...
            tk.Button(self.tec_course_page, text="Computer Engineering", width=30, bg="SteelBlue3",
                ...
                x=270, y=200)
            tk.Button(self.tec_course_page, text="Civil Engineering", width=30, bg="SteelBlue3",
                      font="helvetica, 12", command=lambda: [self.show_frame(self.tec_course_page),
                                                             self.show_frame(self.civil_course_select_frame)]).place(
                x=270, y=240)
            tk.Button(self.tec_course_page, text="Mechanical Engineering", width=30, bg="SteelBlue3",
                      font="helvetica, 12", command=lambda: [self.show_frame(self.tec_course_page),
        ...
        def Courseselection():
            ...
            tk.Button(self.gen_course_select_frame, text="<-- Back", width=10, bg="light blue", font="helvetica, 12",
                      command=lambda: [self.show_frame(self.main_frame)]).place(x=550, y=350)
            ...
            tk.Button(self.elec_course_select_frame, text=Electrical_courses[0], width=80,
                      ...
                      command=lambda: [self.show_frame(self.enroll_drop_frame),
                                       self.logCourse(General_courses[0])]).place(x=270, y=120)

            tk.Button(self.elec_course_select_frame, text=Electrical_courses[1], width=80,
                      bg="medium turquoise", font="helvetica, 12",
                      command=lambda: [self.show_frame(self.enroll_drop_frame),
                                       self.logCourse(General_courses[1])]).place(x=270, y=160)
            ...
            tk.Button(self.elec_course_select_frame, text="<-- Back", width=10, bg="light blue", font="helvetica, 12",
                      command=lambda: [self.show_frame(self.tec_course_page)]).place(x=550, y=350)
            ...
            # Civil Engineering
            Civil_courses = ["CE1:Structual Engineering",
            ...
            tk.Label(self.nontec_course_select_frame, text="Non-Technical Workshops", width=100, font="bold, 30",
